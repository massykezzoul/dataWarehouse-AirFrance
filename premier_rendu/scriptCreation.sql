...
DROP TABLE stock_avions;
DROP TABLE dimension_aeroport;
DROP TABLE dimension_client;
...
CREATE TABLE dimension_aeroport
(
    id NUMBER(5) PRIMARY KEY,
    ...
    nom_aeroport VARCHAR2(20) NOT NULL,
    type_aeroport VARCHAR2(20),
...
(
    ...
    aeroport_depart NUMBER(5),
    FOREIGN KEY(aeroport_depart) REFERENCES dimension_aeroport(id),
    aeroport_arrivee NUMBER(5),
    FOREIGN KEY(aeroport_arrivee) REFERENCES dimension_aereport(id),
    num_vol NUMBER(5),
...
CREATE TABLE stock_avions
(
    num_avion NUMERIC(5),
    FOREIGN KEY(num_avion) REFERENCES dimension_avion(id),
    date_jour NUMERIC(5),
    FOREIGN KEY(date_jour) REFERENCES dimension_date(id),
    aeroport NUMERIC(5),
    FOREIGN KEY(aeroport) REFERENCES dimension_aeroport(id),
    nombre_vol NUMBER(5),
    nombre_km NUMBER(5),
    carburant_consomme NUMBER(5),
    recette NUMBER(5)
);